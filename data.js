...
const DATOS = {
  ...
  perfil: {
    ...
    descripcion:
      "Ingeniero en Ciencias de la Computación y Máster en Ingeniería del Software. Construyo <b>sitios y aplicaciones web</b>, administro <b>servidores y plataformas educativas</b> (Moodle) y aplico <b>ciencia de datos e IA</b> para resolver problemas reales.",
  ...
  sobreMi: {
    ...
    enfoque: {
      titulo: "Enfoque",
      descripcion:
        "Soluciones web y de sistemas confiables, con documentación clara y despliegue reproducible.",
    },
    miniCards: [
    ...
    cardAncha: {
      ...
      subtitulo: "Moodle a medida para instituciones",
    },
  },
  ...
  servicios: [
    {
      ...
      descripcion:
        "Sitios y aplicaciones modernas con React.js, Node.js y Supabase. Desde landing pages hasta sistemas a medida.",
    },
    {
      icono: "server",
      titulo: "Administración de Sistemas",
      descripcion:
        "Despliegue y gestión de servidores Linux, contenedores con Coolify y arquitectura en la nube con AWS.",
    },
    {
      icono: "edu",
      titulo: "Plataformas Educativas",
      descripcion:
        "Implementación, personalización y soporte de Moodle para instituciones y centros de formación.",
    },
    {
      icono: "chart",
      titulo: "Ciencia de Datos e IA",
      descripcion:
        "Modelos de Machine Learning y análisis de datos con Python aplicados a la toma de decisiones.",
    },
  ],
  ...
  proyectos: [
    {
      ...
      anio: "2023",
      descripcion:
        "Sitio web institucional del instituto: oferta académica, noticias y servicios en línea.",
      tags: ["Web", "Linux", "Coolify"],
      url: "https://istah.edu.ec/",
      imagen: "assets/proyectos/web-istah.png",
    ...
    },
    {
      ...
      anio: "2023",
      descripcion:
        "Campus virtual Moodle para carreras tecnológicas: cursos, evaluaciones y gestión de usuarios.",
      tags: ["Moodle", "Linux", "Coolify"],
      url: "https://eva.istah.edu.ec/",
      imagen: "assets/proyectos/eva-istah.png",
    ...
    },
    {
      ...
      anio: "2022",
      descripcion:
        "Sitio institucional con noticias, trámites y servicios para socios, desplegado en servidor propio.",
      tags: ["React.js", "Node.js", "Linux"],
      url: "https://sindicatoespejo.com.ec/",
      imagen: "assets/proyectos/web-sindicato.png",
    ...
    },
    {
      ...
      anio: "2022",
      descripcion:
        "Campus Moodle para cursos de conducción: matrículas, evaluaciones y certificados en línea.",
      tags: ["Moodle", "Coolify", "Linux"],
      url: "https://eva.sindicatoespejo.com.ec/",
      imagen: "assets/proyectos/eva-sindicato.png",
      placeholder: "Captura del campus EVA",
    },
    {
      ...
      anio: "2024",
      descripcion:
        "Tienda en línea con catálogo, carrito y pagos, orientada a venta mayorista y gestión de inventario.",
      tags: ["React.js", "Node.js", "Supabase"],
      url: "https://elmayoristaec.com/",
      imagen: "assets/proyectos/tienda-elmayorista.png",
  ...
  habilidades: [
    {
      icono: "frontend",
      titulo: "Frontend",
      tags: ["JavaScript", "React.js", "Angular", "HTML · CSS"],
    },
    {
      icono: "backend",
      titulo: "Backend & Datos",
      tags: ["Node.js", "Supabase", "Python", "PostgreSQL"],
    },
    {
      icono: "devops",
      titulo: "Sistemas & DevOps",
      tags: ["Linux", "Coolify", "AWS", "Docker"],
    },
    {
      icono: "ia",
      titulo: "Plataformas & IA",
      tags: ["Moodle", "Machine Learning", "CRISP‑DM", "IA Generativa"],
    },
  ],
  ...
  experiencia: [
    {
      puesto: "Docente – Área de Tecnología",
      organizacion: "SENESCYT · Secretaría de Educación Superior",
      periodo: "Jul 2023 – Actualidad",
      actual: true,
      descripcion:
        "Docencia superior en tecnología y análisis de datos; acompañamiento académico e integración de herramientas digitales e IA aplicada.",
    },
    {
      puesto: "Desarrollador / Técnico TIC",
      organizacion: "Sindicato de Choferes Profesionales de Espejo",
      periodo: "2020 – 2023",
      actual: false,
      descripcion:
        "Desarrollo del sitio web y campus Moodle, administración de servidores y soporte técnico integral a la institución.",
    },
    {
      puesto: "Docente Suplente",
      organizacion: "Escuela de Capacitación para Conductores Profesionales",
      periodo: "2020 – 2023",
      actual: false,
      descripcion:
        "Formación técnica y manejo de plataformas virtuales de aprendizaje.",
    },
    {
      puesto: "Técnico de Apoyo a Municipios",
      organizacion: "SERESCO",
      periodo: "Ene – Mar 2016",
      actual: false,
      descripcion:
        "Soporte técnico y mantenimiento de sistemas informáticos municipales.",
    },
    {
      puesto: "Técnico de Redes",
      organizacion: "AIRTIFICIAL",
      periodo: "2014 – 2015",
      actual: false,
      descripcion:
        "Instalación, configuración y mantenimiento de infraestructura de redes.",
    },
  ],
  ...
  titulos: [
    {
      destacado: true,
      meta: "2025 · ESPAÑA",
      titulo: "Máster en Ingeniería del Software y Sistemas Informáticos",
      organizacion: "Universidad Internacional de La Rioja (UNIR)",
    },
    {
      destacado: false,
      meta: "2023 · ECUADOR",
      titulo: "Ingeniero en Ciencias de la Computación",
      organizacion: "Universidad Politécnica Estatal del Carchi (UPEC)",
    },
  ],
  ...
  certificaciones: [
    {
      ...
      organizacion: "UNIR · España",
      meta: "50 horas",
      anio: "2024",
    },
    {
      titulo: "IA Generativa Aplicada a la Educación",
      organizacion: "UNIR · España",
      meta: "Sobresaliente (10) · 150 h",
      anio: "2024",
    },
    {
    ...
    {
      titulo: "Digital Project Management",
      organizacion: "MIU City University · Miami",
      meta: "160 horas",
      anio: "2025",
    },
    {
      titulo: "Cultura de la Investigación",
      organizacion: "UNIR · España",
      meta: "Notable · 100 h",
      anio: "2024",
    },
    {
      titulo: "Neurodidáctica",
      organizacion: "Profuturo · F. Telefónica",
      meta: "40 horas",
      anio: "2023",
    },
  ],
  ...
  publicaciones: [
    {
      titulo:
        "Modelo para la predicción de precios de productos agrícolas de Carchi mediante técnicas de aprendizaje automático",
  ...
  contacto: [
    {
      tipo: "email",
      etiqueta: "Email",
      valor: "juanga_esp@outlook.es",
      enlace: "mailto:juanga_esp@outlook.es",
    },
    {
      tipo: "whatsapp",
      etiqueta: "WhatsApp · Teléfono",
      valor: "0998463093",
      enlace: "https://wa.me/593998463093",
    },
    {
      tipo: "ubicacion",
      etiqueta: "Ubicación",
      valor: "El Ángel · Carchi, Ecuador",
      enlace: "",
    },
  ],
